...
const sections = [
  { label: "Ventas", icon: <ShoppingCartCheckoutIcon fontSize="large" />, path: "/ventas" },
  { label: "Compras", icon: <StoreIcon fontSize="large" />, path: "/compras" },
  { label: "Clientes", icon: <GroupIcon fontSize="large" />, path: "/clientes" },
  { label: "Productos", icon: <WidgetsIcon fontSize="large" />, path: "/productos" },
